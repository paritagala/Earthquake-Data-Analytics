...
max_magnitude_earthquake = df[df['mag'] == max_magnitude]

print(f"The maximum magnitude in 2017 is {max_magnitude}.")
print("Details of the earthquake with the maximum magnitude:")
print(max_magnitude_earthquake)

# Write to Excel file
excel_file = 'earthquake_data_2017_max.xlsx'
